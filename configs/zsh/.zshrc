...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(virtualenv user_joined dir vcs newline os_icon prompt_char_joined)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(background_jobs date time_joined battery newline load ram_joined wifi)
...
POWERLEVEL9K_LOAD_BACKGROUND="3"
